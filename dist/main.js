...
// EXTERNAL MODULE: ./node_modules/css-loader/dist/cjs.js!./node_modules/mini-css-extract-plugin/dist/loader.js!./node_modules/css-loader/dist/cjs.js!./src/front/css/normalize.css
...
class ValidaCadena{constructor(a,b){this.campo=a,this.valor=b,this.patron=this.asignaPatron(),this.mensaje}asignaPatron(){return"nombre"===this.campo||"apellido"===this.campo?(this.patron=new RegExp(/^[a-zA-Z\s]*$/),this.mensaje="Este campo solo admite caracteres alfabeticos!!"):"dni"===this.campo?(this.patron=new RegExp(/^[0-9]*(\.[0-9]*)*$/),this.mensaje="Solo se admiten numeros para ingresar DNI!!"):"telefono"===this.campo&&(this.patron=new RegExp(/^\d*[-|\s]*\d*[-|\s]*\d*$/),this.mensaje="Ingrese telefono con el siguiente fomato 11 5555-6666"),void this.valida()}valida(){if(!this.patron.test(this.valor))return void alert(this.mensaje)}}
;// ./src/front/js/index.js
const nombre=document.querySelector("#nombre"),apellido=document.querySelector("#apellido"),dni=document.querySelector("#dni"),telefono=document.querySelector("#telefono");nombre.addEventListener("input",valida),apellido.addEventListener("input",valida),dni.addEventListener("input",valida),telefono.addEventListener("input",valida);function valida(a){new ValidaCadena(a.target.id,a.target.value)}
/******/ })()
;